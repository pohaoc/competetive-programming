...
class fastflow {
  ...
  vector<vector<int>> max_bipart_match(int a, int b){
      //add the following to main
      //fastflow<int> g(n+m+2, 0, n+m+1)
      //g.add(u,v+n, 1,0) to construct edges between the two parties
